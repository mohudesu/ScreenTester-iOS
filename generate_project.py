...
files = [obj(10+i, isa='PBXFileReference', lastKnownFileType='sourcecode.swift', path=name, sourceTree='<group>')
         for i, name in enumerate(['App.swift', 'TestController.swift', 'TestCanvas.swift'])]
...
build_files = [obj(20+i, isa='PBXBuildFile', fileRef=ref) for i, ref in enumerate(files)]
